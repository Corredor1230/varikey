...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) {
		...
		m->declare("filename", "faustDemo1.dsp");
		m->declare("name", "faustDemo1");
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("faustDemo1");
		ui_interface->addHorizontalSlider("Gain", &fHslider0, -20.0f, -60.0f, 0.0f, 1.0f);
