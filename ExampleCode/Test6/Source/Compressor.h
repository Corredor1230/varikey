...
// faust -a arch.cpp -i -cn Compressor Compressor.dsp -o ../Compressor.h
/************************** BEGIN misc.h **************************/
/************************************************************************
...
class Compressor : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Attack", &fHslider1, 10.0f, 1.0f, 100.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec0[0] = fRec1[0];
			output0[i] = FAUSTFLOAT((9.99999975e-05f * (fTemp0 * std::pow(10.0f, (fSlow0 * std::max<float>(0.0f, ((20.0f * std::log10(fRec0[0])) - fSlow7)))))));
			fRec1[1] = fRec1[0];
			fRec0[1] = fRec0[0];
		}
	}
