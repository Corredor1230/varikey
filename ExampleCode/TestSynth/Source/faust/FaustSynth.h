...
class FaustSynth : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("Cutoff", &fVslider0, FAUSTFLOAT(1000.0f), FAUSTFLOAT(20.0f), FAUSTFLOAT(20000.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fHslider2, "scale", "log");
		ui_interface->addHorizontalSlider("Frequency2", &fHslider2, FAUSTFLOAT(300.0f), FAUSTFLOAT(20.0f), FAUSTFLOAT(20000.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fHslider1, "scale", "log");
		ui_interface->addHorizontalSlider("Frequency", &fHslider1, FAUSTFLOAT(200.0f), FAUSTFLOAT(20.0f), FAUSTFLOAT(20000.0f), FAUSTFLOAT(1.0f));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp3 = std::max<float>(1.1920929e-07f, std::fabs(fRec6[0]));
			float fTemp4 = (fConst4 * fTemp3);
			float fTemp5 = (fRec4[1] + fTemp4);
			float fTemp6 = (fTemp5 + -1.0f);
			int iTemp7 = (fTemp6 < 0.0f);
			fRec4[0] = (iTemp7 ? fTemp5 : fTemp6);
			float fThen1 = (fRec4[1] + (fTemp4 + ((1.0f - (fConst0 / fTemp3)) * fTemp6)));
			float fRec5 = (iTemp7 ? fTemp5 : fThen1);
			float fTemp8 = (fRec3[0] * ((2.0f * fRec5) + -1.0f));
			fVec0[0] = fTemp8;
			float fTemp9 = (fTemp1 + 1.0f);
			fRec1[0] = (0.0f - (((fRec1[1] * fTemp2) - (fTemp8 + fVec0[1])) / fTemp9));
			float fTemp10 = (((fTemp1 + -1.0f) / fTemp0) + 1.0f);
			float fTemp11 = (1.0f - (1.0f / FaustSynth_faustpower2_f(fTemp0)));
			float fTemp12 = (((fTemp1 + 1.0f) / fTemp0) + 1.0f);
			fRec0[0] = (fRec1[0] - (((fRec0[2] * fTemp10) + (2.0f * (fRec0[1] * fTemp11))) / fTemp12));
			output0[i0] = FAUSTFLOAT(((fRec0[2] + (fRec0[0] + (2.0f * fRec0[1]))) / fTemp12));
			fRec11[0] = (fSlow3 + (fConst3 * fRec11[1]));
			float fTemp13 = std::max<float>(1.1920929e-07f, std::fabs(fRec11[0]));
			float fTemp14 = (fConst4 * fTemp13);
			float fTemp15 = (fRec9[1] + fTemp14);
			float fTemp16 = (fTemp15 + -1.0f);
			int iTemp17 = (fTemp16 < 0.0f);
			fRec9[0] = (iTemp17 ? fTemp15 : fTemp16);
			float fThen3 = (fTemp14 + (fRec9[1] + ((1.0f - (fConst0 / fTemp13)) * fTemp16)));
			float fRec10 = (iTemp17 ? fTemp15 : fThen3);
			float fTemp18 = (fRec3[0] * ((2.0f * fRec10) + -1.0f));
			fVec1[0] = fTemp18;
			fRec8[0] = (0.0f - (((fTemp2 * fRec8[1]) - (fTemp18 + fVec1[1])) / fTemp9));
			fRec7[0] = (fRec8[0] - (((fTemp10 * fRec7[2]) + (2.0f * (fTemp11 * fRec7[1]))) / fTemp12));
			output1[i0] = FAUSTFLOAT(((fRec7[2] + (fRec7[0] + (2.0f * fRec7[1]))) / fTemp12));
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fRec6[1] = fRec6[0];
			fRec4[1] = fRec4[0];
 ...
 */
class FaustSynth_poly : public dsp_voice_group, public dsp_poly {
    ...
    private:
        ...
        {
            if (val == FAUSTFLOAT(1)) {
                static_cast<FaustSynth_poly*>(arg)->allNotesOff(true);
            }
        }
    ...
    public:
         ...
         * Constructor.
         *
         * @param dsp - the dsp to be used for one voice. Beware: FaustSynth_poly will use and finally delete the pointer.
        ...
        virtual FaustSynth_poly* clone()
        {
            return new FaustSynth_poly(fDSP->clone(), int(fVoiceTable.size()), fVoiceControl, fGroupControl);
        }
...
struct dsp_poly_factory : public dsp_factory {
    ...
    {
        dsp_poly* dsp_poly = new FaustSynth_poly(adaptDSP(fProcessFactory->createDSPInstance(), is_double), nvoices, control, group);
        if (fEffectFactory) {
...
class FaustPolyEngine {
    ...
    protected:
        ...
        FaustSynth_poly* fPolyDSP;     // the polyphonic Faust object
        ...
        void init(dsp* mono_dsp, audio* driver, midi_handler* handler)
        {
            ...
            if (nvoices > 0) {
                ...
                fPolyDSP = new FaustSynth_poly(mono_dsp, nvoices, true);
    ...
    public:
        ...
        {
            init(((mono_dsp) ? mono_dsp : new FaustSynth()), driver, midi);
        }
...
//faust -a arch.cpp -i -cn FaustSynth FaustSynth.dsp -o ../FaustSynth.h
