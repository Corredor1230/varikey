...
struct DefaultParameters {
    const static int defaultLowValueFirstParameter = 0;
    const static int defaulthiValueFirstParameter = 10;
    const static int defaultdefValueFirstParameter = 3;
};


class SomeOscillator {
public:
