...
class OscillatorSIG0 {
  ...
  public:
	...
	int getNumInputsOscillatorSIG0() {
		return 0;
	}
	int getNumOutputsOscillatorSIG0() {
		return 1;
	}
	int getInputRateOscillatorSIG0(int channel) {
		int rate;
		switch ((channel)) {
			default: {
				rate = -1;
	...
	int getOutputRateOscillatorSIG0(int channel) {
		int rate;
		switch ((channel)) {
			case 0: {
				rate = 0;
	...
	void instanceInitOscillatorSIG0(int sample_rate) {
		for (int l0 = 0; (l0 < 2); l0 = (l0 + 1)) {
			iRec0[l0] = 0;
		}
	}
	
	void fillOscillatorSIG0(int count, float* table) {
...
static OscillatorSIG0* newOscillatorSIG0() { return (OscillatorSIG0*)new OscillatorSIG0(); }
static void deleteOscillatorSIG0(OscillatorSIG0* dsp) { delete dsp; }

static float ftbl0OscillatorSIG0[65536];

#ifndef FAUSTCLASS 
#define FAUSTCLASS Oscillator
#endif
...
class Oscillator : public dsp {
 ...
 public:
	...
	static void classInit(int sample_rate) {
		OscillatorSIG0* sig0 = newOscillatorSIG0();
		sig0->instanceInitOscillatorSIG0(sample_rate);
		sig0->fillOscillatorSIG0(65536, ftbl0OscillatorSIG0);
		deleteOscillatorSIG0(sig0);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("freq", &fHslider1, 1000.0f, 20.0f, 20000.0f, 1.0f);
		ui_interface->addHorizontalSlider("gain", &fHslider0, -12.0f, -60.0f, 0.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = FAUSTFLOAT((fSlow0 * ftbl0OscillatorSIG0[int((65536.0f * fRec1[0]))]));
			fRec1[1] = fRec1[0];
		}
	}
