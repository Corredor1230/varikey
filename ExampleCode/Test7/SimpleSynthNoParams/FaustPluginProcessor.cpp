...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("freq", &fHslider1, 1000.0f, 10.0f, 10000.0f, 1.0f);
	...
	#define FAUST_FILE_NAME "SimpleSynth.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("freq", fHslider1, 1000.0f, 10.0f, 10000.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("gain", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDCHECKBOX("gate", fCheckbox0);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, freq, "freq", fHslider1, 1000.0f, 10.0f, 10000.0f, 1.0f) \
		p(HORIZONTALSLIDER, gain, "gain", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(CHECKBOX, gate, "gate", fCheckbox0, 0.0f, 0.0f, 1.0f, 1.0f) \
