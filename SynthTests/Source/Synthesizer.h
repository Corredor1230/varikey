 ...
 */
class Synthesizer_poly : public dsp_voice_group, public dsp_poly {
    ...
    private:
        ...
        {
            if (val == FAUSTFLOAT(1)) {
                static_cast<Synthesizer_poly*>(arg)->allNotesOff(true);
            }
        }
    ...
    public:
         ...
         * Constructor.
         *
         * @param dsp - the dsp to be used for one voice. Beware: Synthesizer_poly will use and finally delete the pointer.
        ...
        virtual Synthesizer_poly* clone()
        {
            return new Synthesizer_poly(fDSP->clone(), int(fVoiceTable.size()), fVoiceControl, fGroupControl);
        }
...
struct dsp_poly_factory : public dsp_factory {
    ...
    {
        dsp_poly* dsp_poly = new Synthesizer_poly(adaptDSP(fProcessFactory->createDSPInstance(), is_double), nvoices, control, group);
        if (fEffectFactory) {
...
class Synthesizer : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("vDepth", &fVslider12, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->addVerticalSlider("vFreq", &fVslider13, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(20.0f), FAUSTFLOAT(0.0199999996f));
		ui_interface->closeBox();
		...
		ui_interface->addVerticalSlider("c", &fVslider15, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider16, "2", "");
		ui_interface->addVerticalSlider("ces", &fVslider16, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider14, "3", "");
		ui_interface->addVerticalSlider("d", &fVslider14, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider7, "4", "");
		ui_interface->addVerticalSlider("des", &fVslider7, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider9, "5", "");
		ui_interface->addVerticalSlider("e", &fVslider9, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider8, "6", "");
		ui_interface->addVerticalSlider("f", &fVslider8, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider10, "7", "");
		ui_interface->addVerticalSlider("fes", &fVslider10, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider11, "8", "");
		ui_interface->addVerticalSlider("g", &fVslider11, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider3, "9", "");
		ui_interface->addVerticalSlider("ges", &fVslider3, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider4, "", "");
		ui_interface->addVerticalSlider("a", &fVslider4, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider5, "", "");
		ui_interface->addVerticalSlider("as", &fVslider5, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->declare(&fVslider6, "", "");
		ui_interface->addVerticalSlider("b", &fVslider6, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00100000005f));
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow7 = float((fSlow6 == 8.0f));
		float fSlow8 = (fConst8 * float(fVslider3));
		float fSlow9 = float((fSlow6 == 9.0f));
		float fSlow10 = (fConst8 * float(fVslider4));
		float fSlow11 = float((fSlow6 == 10.0f));
		float fSlow12 = (fConst8 * float(fVslider5));
		float fSlow13 = float((fSlow6 == 11.0f));
		float fSlow14 = (fConst8 * float(fVslider6));
		float fSlow15 = float((fSlow6 == 3.0f));
		float fSlow16 = (fConst8 * float(fVslider7));
		float fSlow17 = float((fSlow6 == 5.0f));
		float fSlow18 = (fConst8 * float(fVslider8));
		float fSlow19 = float((fSlow6 == 4.0f));
		float fSlow20 = (fConst8 * float(fVslider9));
		float fSlow21 = float((fSlow6 == 6.0f));
		float fSlow22 = (fConst8 * float(fVslider10));
		float fSlow23 = float((fSlow6 == 7.0f));
		float fSlow24 = (fConst8 * float(fVslider11));
		float fSlow25 = float(fVslider12);
		float fSlow26 = (fConst8 * float(fVslider13));
		float fSlow27 = float((fSlow6 == 2.0f));
		float fSlow28 = (fConst8 * float(fVslider14));
		float fSlow29 = float((fSlow6 == 0.0f));
		float fSlow30 = (fConst8 * float(fVslider15));
		float fSlow31 = (fConst8 * float(fHslider1));
		float fSlow32 = float((fSlow6 == 1.0f));
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			fRec20[0] = (fSlow26 + (fConst9 * fRec20[1]));
			float fTemp4 = (fRec19[1] + (fConst10 * fRec20[0]));
			fRec19[0] = (fTemp4 - std::floor(fTemp4));
			fRec21[0] = (fSlow28 + (fConst9 * fRec21[1]));
			fRec22[0] = (fSlow30 + (fConst9 * fRec22[1]));
			fRec23[0] = (fSlow31 + (fConst9 * fRec23[1]));
			fRec24[0] = (fSlow33 + (fConst9 * fRec24[1]));
			float fTemp5 = (((fSlow7 * fRec10[0]) + ((fSlow9 * fRec11[0]) + ((fSlow11 * fRec12[0]) + ((fSlow13 * fRec13[0]) + ((fSlow15 * fRec14[0]) + ((fSlow17 * fRec15[0]) + ((fSlow19 * fRec16[0]) + ((fSlow21 * fRec17[0]) + ((fSlow23 * fRec18[0]) + ((fSlow25 * ftbl0SynthesizerSIG0[int((65536.0f * fRec19[0]))]) + ((fSlow27 * fRec21[0]) + ((fSlow29 * fRec22[0]) + (fRec23[0] + (fSlow32 * fRec24[0])))))))))))))) + -69.0f);
			...
			float fThen5 = (fTemp26 + (fRec37[1] + (fTemp28 * (1.0f - (fConst0 / fTemp25)))));
